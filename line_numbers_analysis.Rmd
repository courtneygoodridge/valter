...
Rgression plot shows positive relationship between number magnitude and RTs i.e. as number magnitude increases, so do RTs. 

**TO DO**

Perform regression and see if it matches Valter's on slide 4