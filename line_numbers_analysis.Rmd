...
Hence the logistic regression analysis matches the analysis on slide 5, however I feel I have used more appropriate analyse techniques given the nature of the data. 

**TO DO** 

Compute t test for errors for odd and even numbers - is there such thing as a logistic regression?