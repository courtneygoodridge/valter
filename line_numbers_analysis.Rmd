...
Appears to the show a fairly strong parity x hand - following ANOVA comes out as significant 

**2x2 factorial ANOVA**

The results demonstrate no significant main effects but there is a significant interaction (large effect size). This appears to be standard MARC effect i.e. RTs are faster when the parity and hand are congruent (even with right, odd with left). 

**TO DO**
COMPUTE T-TEST FOR ODD EFFECT WITH CORRECT NUMBER OF DEGREES OF FREEDOM.
