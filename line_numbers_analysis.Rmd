...
ANOVA reveals significant interaction between parity and hand responded with, alongside a large effect size indicating a MARC effect [f(1, 37 = 5.38, p < 0.001, eta^2 = 0.127)].
...
A significant interaction with large effect size indicating a classic SNARC in the exerimental condition where a lawyer is present [f(1,37) = 6.50, p < 0.001, eta^2 = 0.149].
