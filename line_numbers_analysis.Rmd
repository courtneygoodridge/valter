...
The fixed effects coefficient for the interaction (*response_handright:parityeven*) is -0.76 which corresponds to the log of odds ratio between congruent and incongruent response hand/parity pairs.  We exponentiate it to reveal an odds ratio of 0.46 which means the odds of an accurate response are 0.46:1, or 54% lower when response hand and parity are congruent. Hence this highlights an inversed MARC effect.
...
T-test reveales significant odd effect - faster reaction times for even numbers, however the effect size is small.
