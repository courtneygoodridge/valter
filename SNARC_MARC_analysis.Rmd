...
ggplot(IES_data, aes(x = correct_RR, y = meanRT)) +
  ...
  ggsave('RT_PC_relationship_control.bmp', plot = last_plot(), width = 10, height = 7, units = 'cm', dpi = 300)
...
ggplot(controltrue %>%
  ...
  theme_plot +
  theme(legend.position = c(0.50, 0.90), legend.key.height = unit(0, 'cm'), legend.key.width = unit(0.5, 'cm'), legend.key.size = unit(0, 'cm'), strip.text.x = element_blank(), plot.title = element_text(size = 20, face = "bold"), panel.spacing = unit(2, "lines"), axis.title.x = element_text(size = 8), axis.text.x = element_text(size = 8), axis.title.y = element_text(size = 8), axis.text.y = element_text(size = 8), title = element_text(size = 7), legend.title = element_text(size = 8), legend.text = element_text(size = 8)) +
  ggsave('SNARC_RT_control.bmp', plot = last_plot(), width = 10, height = 7, units = 'cm', dpi = 300)
...
ggplot(controltrue %>%
  ...
  ggsave('SNARC_errors_control.bmp', plot = last_plot(), width = 10, height = 7, units = 'cm', dpi = 300)
...
ggplot(IES_data %>%
  ...
  theme_plot +
  theme(legend.position = c(0.55, 0.90), legend.key.height = unit(0, 'cm'), legend.key.width = unit(0.5, 'cm'), legend.key.size = unit(0, 'cm'), strip.text.x = element_blank(), plot.title = element_text(size = 20, face = "bold"), panel.spacing = unit(2, "lines"), axis.title.x = element_text(size = 8), axis.text.x = element_text(size = 8), axis.title.y = element_text(size = 8), axis.text.y = element_text(size = 8), title = element_text(size = 7), legend.title = element_text(size = 8), legend.text = element_text(size = 8)) +
  ggsave('SNARC_IES_control.bmp', plot = last_plot(), width = 10, height = 7, units = 'cm', dpi = 300)
...
ggplot(IES_data, aes(x = correct_RR, y = meanRT)) +
  ...
  theme_plot +
  theme(legend.position = c(0.50, 0.90), legend.key.height = unit(0, 'cm'), legend.key.width = unit(0.5, 'cm'), legend.key.size = unit(0, 'cm'), strip.text.x = element_blank(), plot.title = element_text(size = 20, face = "bold"), panel.spacing = unit(2, "lines"), axis.title.x = element_text(size = 8), axis.text.x = element_text(size = 8), axis.title.y = element_text(size = 8), axis.text.y = element_text(size = 8), title = element_text(size = 7), legend.title = element_text(size = 8), legend.text = element_text(size = 8)) +
  ggsave('RT_PC_relationship_police.bmp', plot = last_plot(), width = 10, height = 7, units = 'cm', dpi = 300)
...
ggplot(explie %>%
  ...
  theme_plot +
  theme(legend.position = c(0.50, 0.90), legend.key.height = unit(0, 'cm'), legend.key.width = unit(0.5, 'cm'), legend.key.size = unit(0, 'cm'), strip.text.x = element_blank(), plot.title = element_text(size = 20, face = "bold"), panel.spacing = unit(2, "lines"), axis.title.x = element_text(size = 8), axis.text.x = element_text(size = 8), axis.title.y = element_text(size = 8), axis.text.y = element_text(size = 8), title = element_text(size = 7), legend.title = element_text(size = 8), legend.text = element_text(size = 8)) +
  ggsave('SNARC_RT_police.bmp', plot = last_plot(), width = 10, height = 7, units = 'cm', dpi = 300)
...
ggplot(explie %>%
  ...
  theme_plot +
  theme(legend.position = c(0.55, 0.90), legend.key.height = unit(0, 'cm'), legend.key.width = unit(0.5, 'cm'), legend.key.size = unit(0, 'cm'), strip.text.x = element_blank(), plot.title = element_text(size = 20, face = "bold"), panel.spacing = unit(2, "lines"), axis.title.x = element_text(size = 8), axis.text.x = element_text(size = 8), axis.title.y = element_text(size = 8), axis.text.y = element_text(size = 8), title = element_text(size = 7), legend.title = element_text(size = 8), legend.text = element_text(size = 8)) +
  ggsave('SNARC_errors_police.bmp', plot = last_plot(), width = 10, height = 7, units = 'cm', dpi = 300)
...
ggplot(IES_data %>%
  ...
  theme_plot +
  theme(legend.position = c(0.55, 0.90), legend.key.height = unit(0, 'cm'), legend.key.width = unit(0.5, 'cm'), legend.key.size = unit(0, 'cm'), strip.text.x = element_blank(), plot.title = element_text(size = 20, face = "bold"), panel.spacing = unit(2, "lines"), axis.title.x = element_text(size = 8), axis.text.x = element_text(size = 8), axis.title.y = element_text(size = 8), axis.text.y = element_text(size = 8), title = element_text(size = 7), legend.title = element_text(size = 8), legend.text = element_text(size = 8)) +
  ggsave('SNARC_IES_police.bmp', plot = last_plot(), width = 10, height = 7, units = 'cm', dpi = 300)

cor.test(IES_data$correct_RR, IES_data$meanRT)
```
...
"response rates"
correct_response_rates <- exptrue %>%
  dplyr::group_by(participant, response_hand, magnitude, accuracy) %>%
  dplyr::summarise(n = n()) %>%
  dplyr::mutate(n_total = sum(n)) %>%
  dplyr::filter(accuracy == 1) %>%
...
ggplot(IES_data, aes(x = correct_RR, y = meanRT)) +
  ...
  theme_plot +
  theme(legend.position = c(0.50, 0.90), legend.key.height = unit(0, 'cm'), legend.key.width = unit(0.5, 'cm'), legend.key.size = unit(0, 'cm'), strip.text.x = element_blank(), plot.title = element_text(size = 20, face = "bold"), panel.spacing = unit(2, "lines"), axis.title.x = element_text(size = 8), axis.text.x = element_text(size = 8), axis.title.y = element_text(size = 8), axis.text.y = element_text(size = 8), title = element_text(size = 7), legend.title = element_text(size = 8), legend.text = element_text(size = 8)) +
  ggsave('RT_PC_relationship_lawyer.bmp', plot = last_plot(), width = 10, height = 7, units = 'cm', dpi = 300)
...
ggplot(exptrue %>%
  ...
  theme_plot +
  theme(legend.position = c(0.50, 0.90), legend.key.height = unit(0, 'cm'), legend.key.width = unit(0.5, 'cm'), legend.key.size = unit(0, 'cm'), strip.text.x = element_blank(), plot.title = element_text(size = 20, face = "bold"), panel.spacing = unit(2, "lines"), axis.title.x = element_text(size = 8), axis.text.x = element_text(size = 8), axis.title.y = element_text(size = 8), axis.text.y = element_text(size = 8), title = element_text(size = 7), legend.title = element_text(size = 8), legend.text = element_text(size = 8)) +
  ggsave('SNARC_RT_lawyer.bmp', plot = last_plot(), width = 10, height = 7, units = 'cm', dpi = 300)
...
ggplot(exptrue %>%
  ...
  theme_plot +
  theme(legend.position = c(0.55, 0.90), legend.key.height = unit(0, 'cm'), legend.key.width = unit(0.5, 'cm'), legend.key.size = unit(0, 'cm'), strip.text.x = element_blank(), plot.title = element_text(size = 20, face = "bold"), panel.spacing = unit(2, "lines"), axis.title.x = element_text(size = 8), axis.text.x = element_text(size = 8), axis.title.y = element_text(size = 8), axis.text.y = element_text(size = 8), title = element_text(size = 7), legend.title = element_text(size = 8), legend.text = element_text(size = 8)) +
  ggsave('SNARC_errors_lawyer.bmp', plot = last_plot(), width = 10, height = 7, units = 'cm', dpi = 300)
...
ggplot(IES_data %>%
  ...
  theme_plot +
  theme(legend.position = c(0.55, 0.90), legend.key.height = unit(0, 'cm'), legend.key.width = unit(0.5, 'cm'), legend.key.size = unit(0, 'cm'), strip.text.x = element_blank(), plot.title = element_text(size = 20, face = "bold"), panel.spacing = unit(2, "lines"), axis.title.x = element_text(size = 8), axis.text.x = element_text(size = 8), axis.title.y = element_text(size = 8), axis.text.y = element_text(size = 8), title = element_text(size = 7), legend.title = element_text(size = 8), legend.text = element_text(size = 8)) +
  ggsave('SNARC_IES_lawyer.bmp', plot = last_plot(), width = 10, height = 7, units = 'cm', dpi = 300)

```

In this condition, participant is shown a picture of a lawyer. This means they have to tell the truth. This is essentially a standard SNARC task but within the conext of being court. As might be expected, the results from the control condition are mirrored here with a standard SNARC effect for RTs but an inverse-SNARC for errors. This suggests a speed accuracy trade-off. 